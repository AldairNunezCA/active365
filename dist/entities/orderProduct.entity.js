...
__decorate([
    (0, typeorm_1.ManyToOne)(() => products_entity_1.Products, (product) => product.orderProducts, { eager: true }),
    __metadata("design:type", products_entity_1.Products)
], OrderProduct.prototype, "product", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => orderDetails_entity_1.OrderDetails, (orderDetails) => orderDetails.orderProducts, { onDelete: "CASCADE" }),
    __metadata("design:type", orderDetails_entity_1.OrderDetails)
], OrderProduct.prototype, "orderDetails", void 0);
__decorate([
...
exports.OrderProduct = OrderProduct = __decorate([
    (0, typeorm_1.Entity)({ name: "OrderProducts" })
], OrderProduct);
